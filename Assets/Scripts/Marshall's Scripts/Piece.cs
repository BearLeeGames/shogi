...
public enum pieceType { Pawn, Lance, Knight, Bishop, Rook, King, Gold, Silver, PromotedRook, PromotedBishop, PromotedSilver, PromotedKnight, PromotedLance, PromotedPawn}
